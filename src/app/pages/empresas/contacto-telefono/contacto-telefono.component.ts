...
import { ContactoTelefono } from 'src/app/interfaces/empresas/contactoTelefono';
import { ErrorService } from 'src/app/services/error.service';
import { ContactoTService } from 'src/app/services/negocio/contactoTelefono.service';
...
@Component({
  ...
  templateUrl:'./contacto-telefono.component.html',
  styleUrls: ['./contacto-telefono.component.css']
})
export class ContactoTelefonoComponent implements OnInit{
